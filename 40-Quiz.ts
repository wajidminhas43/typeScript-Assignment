...
//  the number of tracks, add that value to the album’s Object. Make at least 
...
// function makeAlbum(artistName:any, albumTitle:any, numTracks=) {
...
//   let album1 = makeAlbum('FIELDS OF FREEDOM ', 'Abbey Road', 8);
// let album2 = makeAlbum('Pink Floyd', 'Dark Side of the Moon', 10);
